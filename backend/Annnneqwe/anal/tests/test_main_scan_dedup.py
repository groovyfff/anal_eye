...
def _settings() -> dict[str, Any]:
    return {'rabbitmq': {'url': 'amqp://guest:guest@localhost:5672/', 'exchange': 'analeyes_exchange'}, 'data_provider': {'name': 'yahoo_finance', 'request_delay_s': 0.0, 'max_retries': 1}, 'watchlist': {'stocks': [{'symbol': 'AAPL', 'name': 'Apple'}], 'indices': [], 'metals': [], 'forex': []}, 'market_hours': {'timezone': 'America/New_York', 'stock_open': '09:30', 'stock_close': '16:00', 'pre_market_enabled': False, 'after_hours_enabled': False, 'metal_breaks_utc': []}, 'triggers': {}, 'composite_score': {'weights': {}}, 'logging': {'level': 'INFO', 'service_name': 'external-markets-service'}, 'main_timeframe': '5m', 'history_depth': 10}
